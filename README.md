...
docker build -f Dockerfile_cuda13.1 -t j3soon/hpc-samples:nvhpc-26.3-devel-cuda13.1-ubuntu24.04 .
...
docker run --rm -it --gpus all -v $PWD:/app j3soon/hpc-samples:nvhpc-26.3-devel-cuda13.1-ubuntu24.04
